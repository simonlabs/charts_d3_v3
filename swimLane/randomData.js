(function() {
    ...
    var RandomData = function() {
        ...
        var generateRandomWorkItems = function () {
            var media = [ "VS1 Regular", "VS1 Event", "VS2 Regular", "VS2 Event", "Audio", "Metadata" ];
            var data = [];
            var laneCount = media.length   //randomNumber(5,7)
            ...
            for (var i = 0; i < laneCount; i++) {
                ...
                for (var j = 0; j < totalWorkItems; j++) {
                    ...
                    var dtS = new Date(dt.getFullYear(), dt.getMonth(),
                                       dt.getDate() + (i == 0 || i == 2 ? 1 : randomNumber(1,5)),
                                       randomNumber(8, 16),
                                       0, 0);

                    var dateOffset = i == 0 || i == 2 ? 7 : randomNumber(0,7);
